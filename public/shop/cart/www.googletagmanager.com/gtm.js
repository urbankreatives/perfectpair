      ...
      tags: [
        {
          ...
          vtp_measurementId: "G-3FRKQHQKWF",
...
*/
 ...
 jQuery (c) 2005, 2012 jQuery Foundation, Inc. jquery.org/license. */
  ...
  Pd.fa = "dataLayer";
  Pd.Jh =
    "ChAI8MrfmQYQhZGg8a2RsO1bEiQAwnw9WoyigK8z7B1biF5PSbGgs4h4CjLXckxKqHF2Bi+qvdUaAhX/";
  var Sd = {
      __cl: !0,
      __ecl: !0,
      __ehl: !0,
  ...
  var Dg = { M: "GTM-P789P9T", Gb: "62966713" },
    Eg = { mh: "GTM-P789P9T", nh: "GTM-P789P9T" };
  Dg.Jg = za("");
  var Fg = function () {
  ...
  var fl = cl,
    $k = "https://www.googletagmanager.com/a?id=" + Dg.M + "&cv=2",
    gl = {
      ...
      return new Promise(function (c, d) {
        var e = !1,
          f = E.setTimeout(function () {
            e || ((e = !0), P(106), d(Error("Timeout")));
          }, a);
        b.then(function (g) {
          e || ((e = !0), P(104), c(g), E.clearTimeout(f));
        }).catch(function (g) {
          e || ((e = !0), P(105), d(g), E.clearTimeout(f));
        });
      });
    },
    Ml = function (a, b, c) {
      c = void 0 === c ? !1 : c;
      a &&
        ((b.m[Q.g.Ee] = a.architecture),
        (b.m[Q.g.Fe] = a.bitness),
        a.fullVersionList &&
          (b.m[Q.g.Ge] = a.fullVersionList
            .map(function (d) {
              return (
            ...
            .join("|")),
        c && (b.m[Q.g.sg] = a.mobile ? "1" : "0"),
        (b.m[Q.g.He] = a.model),
        (b.m[Q.g.Ie] = a.platform),
        (b.m[Q.g.Je] = a.platformVersion),
        (b.m[Q.g.Ke] = a.wow64 ? "1" : "0"));
    };
  function Nl() {
  ...
  (Z.o.f = ["google"]),
    (function () {
      (function (a) {
        ...
        var b = kr("gtm.referrer", 1) || F.referrer;
        return b
        ...
        if ("QUERY" === d)
          a: {
            ...
            g
              ...
              : (n = [String(l)]);
            for (var p = 0; p < n.length; p++) {
              var q = Ee(e, "QUERY", void 0, void 0, n[p]);
              if (void 0 != q && (!m || "" !== q)) {
                f = q;
                break a;
              }
    ...
    (function () {
      (function (a) {
        ...
        if (!h(b) || 0 >= b.indexOf("-")) G(a.vtp_gtmOnFailure);
          ...
          var c = Mv(a.vtp_fieldsToSet, "name", "value") || {};
          if (c.hasOwnProperty(Q.g.Ma) || a.vtp_userProperties) {
            var d = c[Q.g.Ma] || {};
            N(Mv(a.vtp_userProperties, "name", "value"), d);
            c[Q.g.Ma] = d;
          }
          a.vtp_enableSendToServerContainer &&
            a.vtp_serverContainerUrl &&
            ((c[Q.g.na] = a.vtp_serverContainerUrl), (c[Q.g.Bd] = !0));
          ...
          xo(to(b, c), a.vtp_gtmEventId, {
            noTargetGroup: !0,
            originatingEntity: Nn(a.vtp_gtmEntityIndex, a.vtp_gtmEntityName),
          });
