...
*/
  ...
  var u = window,
    ...
    z = function (a, b) {
      w.addEventListener
        ? w.addEventListener(a, b, !1)
        : w.attachEvent && w.attachEvent("on" + a, b);
    };
  var A = {},
    B = function (a) {
      A.TAGGING = A.TAGGING || [];
  ...
  var C = /:[0-9]+$/,
    F = function (a, b) {
      ...
      if ("protocol" === b || "port" === b)
        a.protocol = D(a.protocol) || D(u.location.protocol);
      "port" === b
        ? (a.port = String(
