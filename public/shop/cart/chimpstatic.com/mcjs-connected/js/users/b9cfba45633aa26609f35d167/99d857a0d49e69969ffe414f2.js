(function () {
  if (!window.$mcSite) {
    ...
    $mcSite.goal = {
      settings: { uuid: "b9cfba45633aa26609f35d167", dc: "us12" },
    };
  }
})();
/**
...
(function () {
  ...
  var conversion = {
    ...
    processParameters: function () {
      ...
      if (
        this.isValidUTMCampaign(utmCampaignParam) &&
    ...
    injectCartAttributes: function (cartForm, engagement) {
      ...
      for (var attribName in attribs) {
        if (attribs.hasOwnProperty(attribName)) {
          var input = this.createAttributeInputField(
            attribName,
            attribs[attribName]
          );
          p.appendChild(input);
    ...
    getEngagementsSortedByCreatedAt: function () {
      ...
      return engagements.sort(function (a, b) {
    ...
    hasStoredEngagement: function (id) {
      var engagements = this.getEngagements();
      return engagements.filter(function (obj) {
        return obj.id === id;
      }).length === 0
        ? false
        : true;
    ...
    hasStoredMCCIDEngagement: function (mccid) {
      return this.getEngagements().filter(function (obj) {
        return obj.mccid && obj.mccid === mccid;
      }).length === 0
        ? false
        : true;
    },
    ...
    storeEngagement: function (id, source, medium, gclid, expiration) {
      if (!this.hasStoredEngagement(id)) {
        ...
        var engagementObj = this.generateEngagementObject(
          id,
          source,
          medium,
          gclid,
        ...
        this.createCookie(
          "mc_track",
          JSON.stringify(recentEngagements),
          expiration
        );
      }
    },
    ...
    postCartAttributes: function (engagement) {
      ...
      try {
        ...
        console.warn(
          "Unable to set attribution params in Shopify: " + send_error.message
        );
      }
    },
  ...
  if (
    ...
    window.$mcSite.shopify_attribution_cookie === undefined
  ) {
    return;
  }
...
/* eslint-disable */ (function () {
  if (!window.$mcSite.goal.settings || !!$mcSite.goal.installed) {
    return;
  }
  var goalParam = null;
  var goal = {
    getUuid: function () {
      return $mcSite.goal.settings.uuid;
    },
    getDC: function () {
      return $mcSite.goal.settings.dc;
    },
    process: function () {
  ...
  $mcSite.goal.process = goal.process;
  $mcSite.goal.processEvent = goal.processEvent;
  $mcSite.goal.installed = true;
  $mcSite.goal.process();
})();
