/*1668133414,,JIT Construction: v1006584574,en_US*/
...
try {
            ...
            with(this) {
                ...
                __d("fb-error", ["performanceNowSinceAppStart", "removeFromArray"], (function(a, b, c, d, e, f) {
                    ...
                    function L(c) {
                        ...
                        for (var i in n) n[i] == null && delete n[i];
                        return n
                    }
    ...
    i.src = 'https://www.facebook.com/platform/scribe_endpoint.php/?c=jssdk_error&m=' + encodeURIComponent('{"error":"LOAD", "extra": {"name":"' + e.name + '","line":"' + (e.lineNumber || e.line) + '","script":"' + (e.fileName || e.sourceURL || e.script || "sdk.js") + '","stack":"' + (e.stackTrace || e.stack) + '","revision":"1006584574","namespace":"FB","message":"' + e.message + '"}}');
