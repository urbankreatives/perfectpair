! function(o) {
    ...
    window.qodef = {}, qodef.body = o("body"), qodef.html = o("html"), qodef.window = o(window), qodef.windowWidth = o(window).width(), qodef.windowHeight = o(window).height(), qodef.scroll = 0, o(document).ready(function() {
        qodef.scroll = o(window).scrollTop(), i.init(), w.init(), n.init(), s.init(), e.init()
    }), o(window).resize(function() {
        qodef.windowWidth = o(window).width(), qodef.windowHeight = o(window).height()
    }), o(window).scroll(function() {
        qodef.scroll = o(window).scrollTop()
    }), o(document).on("haaken_trigger_get_new_posts", function() {
        w.init(), n.init()
    });
    var i = {
            init: function() {
        ...
        w = {
            ...
            getOptions: function(e, t) {
                var i = void 0 !== e.data("options") ? e.data("options") : {},
                    ...
                    g = h ? ".swiper-button-prev-" + i.unique : e.find(".swiper-button-prev"),
                ...
                return c || (n < 2 ? h = q = v = m = n : n < 3 ? q = v = m = n : n < 4 ? v = m = n : n < 5 && (m = n)), e.hasClass("qodef-side-cut--on") && (c = 1.35, n = parseInt(n) + c, i = parseInt(i), l = parseInt(l), h = parseInt(h), q = parseInt(q), v = parseInt(v) + c, m = parseInt(m) + c, a = !0), Object.assign({
                    slidesPerView: n,
                    centeredSlides: a,
                    sliderScroll: s,
                    spaceBetween: o,
    ...
    var s = {
        items: "",
        init: function(e) {
            this.holder = o(".qodef-anchor"), o.extend(this.holder, e), this.holder.length && (s.items = this.holder, s.clickTrigger(), o(window).on("load", function() {
        ...
        checkAnchorOnScroll: function() {
            ...
            1024 < qodef.windowWidth && ((e = o("#qodef-page-inner *[id]")).length && e.each(function() {
                var e = o(this),
                    t = o('[href*="#' + e.attr("id") + '"]');
                t.length && (s.isTargetInView(e) && s.setActiveState(t), o(window).scroll(function() {
    ...
    var e = {
        init: function() {
            this.holder = o("#qodef-custom-section--uncovering"), this.holder.length && !qodefCore.html.hasClass("touchevents") && 1024 < qodef.windowWidth && (e.addClass(this.holder), e.setHeight(this.holder), e.setAppear(this.holder), o(window).resize(function() {
        ...
        setAppear: function(e) {
            o(window).on("scroll", function() {
                qodef.scroll + e.outerHeight() > o("#qodef-page-content").height() - e.outerHeight() ? e.addClass("qodef-uncovering--active") : e.removeClass("qodef-uncovering--active")
            })
        }
    };
    qodef.qodefUncoveringSection = e, "function" != typeof Object.assign && (Object.assign = function(e) {
...
function(o) {
    ...
    o(document).ready(function() {
        ...
        n.init()
    }), o(document).on("haaken_trigger_get_new_posts", function(e, t) {
    ...
    var s = {
        ...
        setVisibility: function(e, t) {
            ...
            a.additional_query_args = {
                tax_query: t
            }, qodef.body.trigger("haaken_trigger_load_more", [e, 1])
        },
...
function(r) {
    ...
    r(document).ready(function() {
        t.init()
    }), r(document).on("haaken_trigger_get_new_posts", function() {
        t.init()
    });
    var t = {
        init: function() {
...
function(t) {
    ...
    t(document).ready(function() {
        ...
        n.reInit()
    }), t(document).on("haaken_trigger_get_new_posts", function(e, t) {
...
function(a) {
    ...
    a(document).ready(function() {
        ...
        s.scroll()
    }), a(document).on("haaken_trigger_load_more", function(e, t, i) {
                ...
                success: function(e) {
                    "success" === e.status ? (n.max_pages_num !== e.data.max_pages_num && (n.max_pages_num = e.data.max_pages_num), s.setNextPageValue(n, i, !0), s.changeStandardState(t, n.max_pages_num, i), o.waitForImages(function() {
                        s.addPosts(o, e.data.html, i), s.reInitMasonryPosts(t, o), setTimeout(function() {
                            qodef.body.trigger("haaken_trigger_get_new_posts", [t, e.data, i])
                        }, 300)
