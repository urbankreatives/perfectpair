                    ...
                    qodeWidgetsPromoHandler = {
                        ...
                        onMouseDown: function() {
                            var actionURL = elementor.config.elementPromotionURL.replace('%s', this.model.get('name')),
                                ...
                                message = sprintf(wp.i18n.__('Use %s widget and dozens more pro features to extend your toolbox and build sites faster and better.', 'qi-addons-for-elementor'), title);
                            if (this.isQodeWidget()) {
                                var widgetObject = this.getElementObj(this.model.get('name'));
                                if (typeof widgetObject.helpUrl !== 'undefined') {
                                    actionURL = widgetObject.helpUrl;
                                }
                                message = sprintf(wp.i18n.__('The %s comes with advanced professional functionalities and an even smoother website-making experience. %s Upgrade Qi Addons for Elementor %s', 'qi-addons-for-elementor'), title, '<a class="qodef-dialog-box-link" target="_blank" href="https://qodeinteractive.com/qi-addons-for-elementor/pricing/">', '</a>');
                            }
                            elementor.promotion.showDialog({
                                headerMessage: sprintf(wp.i18n.__('%s Widget', 'qi-addons-for-elementor'), title),
                                message: message,
                                top: '-7',
                                element: this.el,
                                actionURL: actionURL
